...
var id = event.senderID;
 ...
 if (event.body.indexOf("ABIR")==0 || (event.body.indexOf("abir vai")==0) || event.body.indexOf("আবির ভাই")==0 ||
event.body.indexOf("Abir vai")==0 ||
event.body.indexOf("Abir vai")==0 ||
event.body.indexOf("আবির")==0 ||
event.body.indexOf("Abir")==0 ||
event.body.indexOf("abir")==0 ||
event.body.indexOf("abir")==0 ||
event.body.indexOf("Abir")==0) {
...
"",
 ...
 var callback = () => api.sendMessage({body:`╭•┄┅════❁🌺❁════┅┄•╮\n প্রিয় মানুষ ডুবে থাকুক,,,\nহৃদওপিন্ডের বিশাল গভিরতায়,,!🌸 \n╰•┄┅════❁🌺❁════┅┄•╯\n\n ${name} আবির এর ইনবক্স :- m.me/61556527816380 \n⋆✦⋆⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⋆✦⋆`,attachment: fs.createReadStream(__dirname + "/cache/")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/"), event.messageID);
